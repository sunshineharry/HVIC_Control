...
class BMP180_2(threading.Thread):
    def __init__(self) -> None:
        super().__init__()
        self.bmp180_1 = BMP180(bus_num=0)
        self.bmp180_2 = BMP180(bus_num=1)

    def run(self):
        while True:
            gl.set_value('preasure_1', self.bmp180_1.get_pressure())
            gl.set_value('preasure_2', self.bmp180_2.get_pressure())
            sleep(1)
